...
class GetAppointmentByFamilyId(generics.GenericAPIView):
    serializer_class = GetAppointment

    def get(self, request, FamilyMemberId):
        result = AppointmentModel.objects.filter(FamilyMemberId=FamilyMemberId)
