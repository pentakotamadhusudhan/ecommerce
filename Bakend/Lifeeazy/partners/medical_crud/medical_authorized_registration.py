...
class MedicalAuthorizedRegisterAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if serializer.is_valid(raise_exception=True):
                ...
                d = {'created_at': created_at,'FirstName':FirstName,'LastName':LastName,
                     'EmailId':EmailId}
                subject, from_email, to = 'Confirmation mail for Registration',  settings.FROM_EMAIL, EmailId
                ...
                response.Result = MedicalAutherizedSerializer(user).data
                response.Status = 200
