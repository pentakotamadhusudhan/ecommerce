...
class ClinicRegisterAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if serializer.is_valid(raise_exception=True):
                ...
                Email = request.data.get('ClinicEmailId')
                ...
                d = {'created_at': created_at,"ClinicName":ClinicName}
                ...
                response.Result = ClinicSerializer(user).data
                response.Status = 200
